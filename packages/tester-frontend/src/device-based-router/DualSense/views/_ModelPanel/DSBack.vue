...
<template>
  ...
  <path v-if="dpad.left"
    ...
    class="ds-active" />
  <path v-if="digitalKeys.touchpad" id="touchpad"
    ...
    class="ds-active" />
  <circle id="cross" v-if="digitalKeys.cross" cx="934.079" cy="428.08" r="34.957" class="ds-active" />
  <circle id="square" v-if="digitalKeys.square" cx="864.079" cy="358.08" r="34.957" class="ds-active" />
  <circle id="circle" v-if="digitalKeys.circle" cx="1004.08" cy="358.08" r="34.957" class="ds-active" />
  <circle id="triangle" v-if="digitalKeys.triangle" cx="934.079" cy="288.08" r="34.957" class="ds-active" />
  <path id="mute" v-if="digitalKeys.mic"
    ...
    class="ds-active" />
  <path id="r1" v-if="digitalKeys.r1"
    ...
    class="ds-active" />
  <path id="l1" v-if="digitalKeys.l1"
    ...
    class="ds-active" />
  <path id="options" v-if="digitalKeys.option"
    ...
    class="ds-active" />
  <path id="create" v-if="digitalKeys.create"
