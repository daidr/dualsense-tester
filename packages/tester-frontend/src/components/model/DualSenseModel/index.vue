...
const rightStickPosition = computed(() => {
    return {
        x: getStickPoint(props.inputVisualInfo.stickRX ?? 0),
        y: getStickPoint(props.inputVisualInfo.stickRY ?? 0)
    }
})

const leftStickPosition = computed(() => {
    return {
        x: getStickPoint(props.inputVisualInfo.stickLX ?? 0),
        y: getStickPoint(props.inputVisualInfo.stickLY ?? 0)
    }
})
    ...
    <svg viewBox="0 0 1117 892">
        <g>
            <path id="r2"
                ...
                class="ds-stroke-normal" :class="{ 'ds-trigger-active': inputVisualInfo.triggerR }" :style="{
                    '--un-fill-opacity': inputVisualInfo.triggerR / 0xFF
                }" />
            <text v-if="showValue" x="970" y="30" font-size="25" class="ds-text">{{
                inputVisualInfo.triggerR
                }}</text>
        </g>
        <g>
            <path id="l2"
                d="M252.212,116.785l-114.214,0c-12.312,0 1.248,-110.916 78.919,-110.916c37.32,-0 51.81,110.916 35.295,110.916Z"
                class="ds-stroke-normal" :class="{ 'ds-trigger-active': inputVisualInfo.triggerL }" :style="{
                    '--un-fill-opacity': inputVisualInfo.triggerL / 0xFF
                }" />
            <text v-if="showValue" x="150" y="30" font-size="25" class="ds-text" text-anchor="end">{{
                inputVisualInfo.triggerL
                }}</text>
        </g>
        <g id="dpad-up">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.up }" />
        ...
        <g id="dpad-down">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.down }" />
        ...
        <g id="dpad-right">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.right }" />
        ...
        <g id="dpad-left">
            <path
                ...
                class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.left }" />
        ...
        <path id="mute"
            ...
            class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.mic }" />
        ...
        <g id="touchpadgroup">
            <path id="touchpad"
                ...
                class="ds-stroke-normal" :class="{ 'ds-touchpad-active': inputVisualInfo.touchpad }" />
        ...
        <path id="r1"
            ...
            class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.r1 }" />
        <path id="l1"
            ...
            class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.l1 }" />
        <path id="options"
            ...
            class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.option }" />
        <path id="create"
            ...
            class="ds-stroke-normal" :class="{ 'ds-active': inputVisualInfo.create }" />
        <g id="create-icon">
        ...
        <g id="r3group">
            ...
            <g :style="{
                ...
                <circle id="r3" cx="763.456" cy="528.548" r="57.193" class="ds-stroke-normal ds-stick"
                    :class="{ 'ds-active': inputVisualInfo.r3 }" />
                <!-- central point -->
            ...
            <text v-if="showValue" x="850" y="700" font-size="25" class="ds-text" text-anchor="end">{{
                formatStickValue(inputVisualInfo.stickRX) }} X</text>
            <text v-if="showValue" x="850" y="730" font-size="25" class="ds-text" text-anchor="end">{{
                formatStickValue(inputVisualInfo.stickRY) }} Y</text>
            <!-- cross line -->
        ...
        <g id="l3group">
            ...
            <g :style="{
                ...
                <circle id="l3" cx="351.764" cy="528.548" r="57.193" class="ds-stroke-normal ds-stick"
                    :class="{ 'ds-active': inputVisualInfo.l3 }" />
                <!-- central point -->
            ...
            <text v-if="showValue" x="270" y="700" font-size="25" class="ds-text">X {{
                formatStickValue(inputVisualInfo.stickLX) }}</text>
            <text v-if="showValue" x="270" y="730" font-size="25" class="ds-text">Y {{
                formatStickValue(inputVisualInfo.stickLY) }}</text>
            <!-- cross line -->
        ...
        <path id="ps"
            ...
            class="ds-ps-icon" :class="{ 'ds-active': inputVisualInfo.ps }" />
    </svg>
</template>
...
svg {
    ...
    .ds-stick {
        @apply fill-white/80 dark-fill-black/80;
    }
