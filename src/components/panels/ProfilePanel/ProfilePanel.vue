...
import { DualSenseType, type DeviceItem, type DSEProfileItem } from '@/dualsense_remove/types';
import { getInputOffset, receiveFeatureReport } from '@/dualsense_remove/utils';
