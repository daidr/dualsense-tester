...
import { formatDspVersion, formatThreePartVersion, formatUpdateVersion, getAssemblePartsInfo, getBatteryBarcode, getBatteryVoltage, getBdMacAddress, getBtPatchInfo, getModuleBarcode, getPcbaId, getPcbaIdFull, getPcbaIdFullString, getSerialNumber, getTouchpadFwVersion, getTouchpadId, getUniqueId, getVcmBarcode, type2TracabilityInfoRead } from '@/utils/dualsense/ds.util'
